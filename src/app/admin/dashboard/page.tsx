          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center">
              <div className="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                <div className="flex items-center px-3 py-2 text-sm font-medium text-brand-neutral-dark">
                  <div className="flex flex-col items-end">
                    <span className="text-brand-primary font-semibold">{adminName}</span>
                    {adminEmail && <span className="text-xs text-brand-neutral">{adminEmail}</span>}
                  </div>
                  <div className="h-8 w-8 rounded-full bg-brand-primary-light text-white flex items-center justify-center ml-3">
